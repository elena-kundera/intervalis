...
export default function Comment() {
    ...
    return(
        ...
        <textarea value={inputText} onChange={(e) => setInputText(e.target.value)} rows={10} cols={100} placeholder='Оставьте ваш комментарий'>
            
        </textarea>
        <button type='submit' className='button'>Отправить комментарий</button>
