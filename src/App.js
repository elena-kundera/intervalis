    ...
    <Router>
      <header className='header'>
        <div className='logo_container'>
          <p className='logo'>
            <Link to='/'>INTERVALIS</Link>
          </p>
        </div>
        <div className='adding_container'>
          <div className='sendNewWord_container'>
            {" "}
            <Link to='/game'>
              <button className='sendNewWord'>Начать игру</button>
            </Link>
          </div>
          <div className='sendNewWord_container'>
            {" "}
            <Link to='/table'>
              <button className='sendNewWord'>Все слова</button>
            </Link>
          </div>
        </div>
      </header>
